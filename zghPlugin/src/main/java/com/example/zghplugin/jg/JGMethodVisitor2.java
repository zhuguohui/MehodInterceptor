 ...
 * @date 2019/2/19
 */
public class JGMethodVisitor2 extends MethodVisitor {
   ...
   static class  EmptyMethodVisitor extends MethodVisitor{
    ...
    public JGMethodVisitor2(JGClassVisitor cv, MethodVisitor mv, String name, ClassNode classNode, String signature, String[] exceptions, String desc) {
    ...
    public AnnotationVisitor visitAnnotation(String desc, boolean visible) {
        ...
        if (JG_DESC.equals(desc)) {
            ...
            //创建修改原有方法的名字
             replaceMethodName = "_confirmed_index"+methodIndex+"_" + name;
